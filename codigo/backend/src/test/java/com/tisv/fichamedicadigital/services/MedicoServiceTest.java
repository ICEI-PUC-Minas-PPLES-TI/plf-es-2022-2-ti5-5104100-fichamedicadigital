...
public class MedicoServiceTest {
	...
	void setUp() throws Exception {
		...
		idDependente = 3L;
		medico = new Medico();
		page = new PageImpl<>(List.of(medico));
		...
		Mockito.when(repository.save(ArgumentMatchers.any())).thenReturn(medico);
	...
	public void findAllPagedDeveRetornarUmaPagina() {
		...
		Page<Medico> result = service.findAllPaged(pageable);

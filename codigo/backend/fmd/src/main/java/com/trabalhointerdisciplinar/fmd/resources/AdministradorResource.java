package com.trabalhointerdisciplinar.fmd.resources;
...
import com.trabalhointerdisciplinar.fmd.services.AdministradorService;
...
public class AdministradorResource {
	...
	public ResponseEntity<Page<AdministradorDTO>> findAll(Pageable pageable) {
		Page<AdministradorDTO> list = service.findAllPaged(pageable);
		return ResponseEntity.ok().body(list);
	}

	@GetMapping(value = "/{id}")
	public ResponseEntity<AdministradorDTO> findBydId(@PathVariable Long id) {
